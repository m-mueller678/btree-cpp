...
OP_LABELS <- c('ycsb_c' = 'ycsb-c', 'ycsb_c_init' = 'insert0', 'ycsb_e' = 'ycsb-e', 'ycsb_e_init' = 'ycsb_e_init','sorted_scan_init'='sorted_scan_init', 'sorted_scan' = 'sorted-scan', 'sorted_insert' = 'sorted insert','insert90'='insert','scan'='scan')
