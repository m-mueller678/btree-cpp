...
CONFIG_LABELS <- c('prefix' = 'prefix truncation', 'dense2' = 'semi dense','dense3' = 'fully dense', 'dense1' = 'no split','hash' = 'fingerprinting', 'inner' = 'integer separators','art'='ART','hot'='HOT','tlx'='TLX')
